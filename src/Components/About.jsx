...
import myImage from '../Resources/Images/me.jpg'
    ...
    return (
        <div id="about">
            ...
            <p>I’m a FullStack web developer. Focused on building products that will make people's lives better.I love to learn new things and I am always open to learn new technologies.</p>
                       <div id='resume'>
                        <a href="https://drive.google.com/uc?export=download&id=1FSo5oxdm9kjFH7gv85969jFnsDjgIOMH">
                            <button data-aos='fade-left'>Download Resume<DownloadIcon /></button>
                        </a>
                        <a href="https://drive.google.com/file/d/1FSo5oxdm9kjFH7gv85969jFnsDjgIOMH/view?usp=share_link" rel="noreferrer" target="_blank">
            ...
            {/* <AboutMeWrapper data-aos='fade-right'>
                ...
                {/* <div className='aboutSection'>
                    ...
                    <div className='left'>
                        ...
                        <h3>About Me</h3>
                        <p></p>
                        <p>Email: <span>shekhar74suman@gmail.com</span></p>
