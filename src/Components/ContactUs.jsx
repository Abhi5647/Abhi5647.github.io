...
const ContactUs = () => {
    ...
    const handleSubmission = (e) => {
        ...
        if (data.name && data.email && data.subject && data.message) {
            emailjs.send("service_7p59htp", "template_7v7lyfj", data, "OOFKAcppyT0J48GS2")
                .then((response) => {
                    setSubmit(true)
                }).catch((error) => {
                    setSubmit(false)
                ...
                <div className='contactText'>
                    ...
                    <div className='middleSection'>
                        <div data-aos='fade-right'>
                            ...
                            <a href="https://github.com/Abhi5647" rel="noreferrer" target="_blank">
                                <p>https://github.com/Abhi5647</p>
                            </a>
                        </div>
                        <div data-aos='fade-right'>
                            ...
                            <a href="https://www.linkedin.com/in/abhishek-kumar-87215723b/" rel="noreferrer" target="_blank">
                                <p>https://www.linkedin.com/in/abhishek-kumar-87215723b/</p>
                            </a>
                        </div>
                        <div  data-aos='fade-right'>
                            ...
                            <h1>Email</h1>
                            <p>You can mail me </p>
                            <a href='mailto:shekhar74suman@gmail.com' rel="noreferrer" target="_blank"><p>myselfabhi56@gmail.com</p></a>
                        </div>
                        <div  data-aos='fade-right'>
                            <PhoneAndroidIcon fontSize="large"/>
                            <h1>Mobile</h1>
                            <p>You can contact me</p>
                            <p style={{color:"teal"}}>+91-8340357424</p>
                        </div>
                    </div>
                </div>
                {submit && <>
